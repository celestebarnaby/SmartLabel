...
IMAGE_EDIT_MAX_PARTIAL_SAMPLES = 10
IMAGE_EDIT_MIN_PARTIAL_SAMPLES = 3
IMAGE_EDIT_NUM_SAMPLED_SUB_EXPRS = 6
IMAGE_SEARCH_NUM_SAMPLED_SUB_EXPRS = 6
IMAGE_EDIT_INIT_PROG_SPACE_SIZE = 50000
IMAGE_SEARCH_INIT_PROG_SPACE_SIZE = 25000
IMAGE_EDIT_AST_SIZE = 8
IMAGE_SEARCH_AST_SIZE = 8
